...
namespace WindowsFormsApplication1
{
	public class Form1 : Form
	{
		...
		{
			Stream manifestResourceStream = myAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.spaceship6.png");
			Image image = Image.FromStream(manifestResourceStream);
			manifestResourceStream = myAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.downwards.png");
			Image image2 = Image.FromStream(manifestResourceStream);
			manifestResourceStream = myAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.hejsatræ.png");
			Image image3 = Image.FromStream(manifestResourceStream);
			manifestResourceStream = myAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.nibble-icon.png");
			Image image4 = Image.FromStream(manifestResourceStream);
			manifestResourceStream = myAssembly.GetManifestResourceStream("WindowsFormsApplication1.Resources.Images.novaart.png");
			...
			for (int i = 0; i < 1980; i++)
			{
				...
				array[i] = kukur.orcish() + " ";
				string[] array2;
				IntPtr value;
				(array2 = array)[(int)(value = (IntPtr)i)] = array2[(int)value] + kukur.orcish() + " ";
				string[] array3;
				IntPtr value2;
				(array3 = array)[(int)(value2 = (IntPtr)i)] = array3[(int)value2] + kukur.orcish() + " ";
				string[] array4;
				IntPtr value3;
				(array4 = array)[(int)(value3 = (IntPtr)i)] = array4[(int)value3] + kukur.orcish() + " ";
				string[] array5;
				IntPtr value4;
				(array5 = array)[(int)(value4 = (IntPtr)i)] = array5[(int)value4] + kukur.orcish() + " ";
				string[] array6;
				IntPtr value5;
				(array6 = array)[(int)(value5 = (IntPtr)i)] = array6[(int)value5] + kukur.orcish() + " ";
				Graphics graphics2 = Graphics.FromImage(image6);
				graphics2.InterpolationMode = InterpolationMode.HighQualityBicubic;
				graphics2.DrawImage(bitmap, 0, 0);
				if (num5 > 55000)
				{
					graphics2.DrawImage(image5, 0f, 0f, (float)((double)bitmap.Width * 1.0), (float)((double)bitmap.Height * 1.0));
				}
				graphics2.DrawString(array[4], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num + 200));
				graphics2.DrawString(array[5], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num + 270));
				graphics2.DrawString(array[51], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num + 300));
				graphics2.DrawString(array[69], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num + 370));
				if (num5 > 80000)
				{
					graphics2.DrawImage(image3, 180f, 0f, (float)((double)image3.Width * 0.5), (float)((double)image3.Height * 0.5));
				}
				if (num4 > 200)
				{
					graphics2.DrawImage(image4, 500, 700);
				}
				if (num4 > 500)
				{
					graphics2.DrawImage(image4, 500f, 290f, (float)((double)image4.Width * 0.5), (float)((double)image4.Height * 0.5));
					graphics2.DrawImage(image4, 410f, 380f, (float)((double)image4.Width * 0.5), (float)((double)image4.Height * 0.5));
					graphics2.DrawImage(image4, 620f, 470f, (float)((double)image4.Width * 0.5), (float)((double)image4.Height * 0.5));
					graphics2.DrawImage(image4, 735f, 560f, (float)((double)image4.Width * 0.5), (float)((double)image4.Height * 0.5));
					graphics2.DrawImage(image4, 540f, 650f, (float)((double)image4.Width * 0.5), (float)((double)image4.Height * 0.5));
					graphics2.DrawImage(image4, 800f, 740f, (float)((double)image4.Width * 0.5), (float)((double)image4.Height * 0.5));
					graphics2.DrawImage(image4, 246f, 830f, (float)((double)image4.Width * 0.5), (float)((double)image4.Height * 0.5));
					graphics2.DrawImage(image4, 372f, 720f, (float)((double)image4.Width * 0.5), (float)((double)image4.Height * 0.5));
					graphics2.DrawImage(image4, 563f, 610f, (float)((double)image4.Width * 0.5), (float)((double)image4.Height * 0.5));
					graphics2.DrawImage(image4, 467f, 590f, (float)((double)image4.Width * 0.5), (float)((double)image4.Height * 0.5));
					graphics2.DrawImage(image4, 798f, 480f, (float)((double)image4.Width * 0.5), (float)((double)image4.Height * 0.5));
					graphics2.DrawImage(image4, 124f, 370f, (float)((double)image4.Width * 0.5), (float)((double)image4.Height * 0.5));
					graphics2.DrawImage(image4, 245f, 260f, (float)((double)image4.Width * 0.5), (float)((double)image4.Height * 0.5));
					graphics2.DrawImage(image4, 762f, 150f, (float)((double)image4.Width * 0.5), (float)((double)image4.Height * 0.5));
				}
				if (num5 > 70000)
				{
					graphics2.DrawImage(image3, 580f, -100f, (float)((double)image3.Width * 0.5), (float)((double)image3.Height * 0.5));
				}
				if (num5 > 50000)
				{
					graphics2.DrawImage(image3, 780f, 400f, (float)((double)image3.Width * 0.5), (float)((double)image3.Height * 0.5));
				}
				graphics2.DrawString(array[0], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num));
				graphics2.DrawString(array[1], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num + 70));
				graphics2.DrawString(array[2], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num + 100));
				graphics2.DrawString(array[3], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num + 170));
				graphics2.DrawString(array[7], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num + 400));
				graphics2.DrawString(array[8], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num + 470));
				graphics2.DrawString(array[9], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num + 500));
				graphics2.DrawString(array[10], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num + 570));
				graphics2.DrawString(array[11], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num + 600));
				graphics2.DrawString(array[12], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num + 670));
				graphics2.DrawString(array[13], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num + 700));
				graphics2.DrawString(array[14], new Font("Segoe Script", 22f, FontStyle.Bold), Brushes.White, new PointF(200f, 1000 - num + 770));
				graphics2.DrawString("Hilsen mig selv haha(Muahaha!!!!)", new Font("Verdana", 24f), Brushes.White, new PointF(200f, 1000 - num + 930));
				graphics2.DrawImage(image, 1600 - num3, 200 + num2);
				if (num3 == junkie.Next(500, 910))
				{
					flag = false;
				}
				if (flag)
				{
					graphics2.DrawString(" --- killimajo fingo jigga willie!!!:)---D tongue out the window...", new Font("Verdana", 36f, FontStyle.Italic), Brushes.WhiteSmoke, new PointF(2000 - num3, 200 + num2));
				}
				if (num4 > 100)
				{
					graphics2.DrawImage(image2, 700, -50000 + num5);
				}
				if (num5 > 40000)
				{
					graphics2.DrawImage(image3, 380f, 280f, (float)((double)image3.Width * 0.5), (float)((double)image3.Height * 0.5));
				}
				graphics2.DrawString("Hej her er teksten på shislak....orcish now approximation...!!", new Font("Verdana", 24f), Brushes.White, new PointF(200f, 900 - num));
				graphics2.Save();
		...
		public void playMP3()
		{
			int selectedIndex = junkie.Next(15);
